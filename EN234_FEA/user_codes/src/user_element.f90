...
subroutine user_element_static(lmn, element_identifier, n_nodes, node_property_list, &           ! Input variables
    ...
    else if ( element_identifier == 1 ) then              ! B-bar 3D linear elastic element
    ...
    else if ( element_identifier == 10001 ) then              ! B-bar 3D linear elastic element
    ...
    else if ( element_identifier == 1002 ) then              ! B-bar 3D linear elastic element
    ...
    else if ( element_identifier == 600 ) then              ! B-bar 3D linear elastic element

        call el_CahnHilliard_2dbasic(lmn, element_identifier, n_nodes, node_property_list, &           ! Input variables
    n_properties, element_properties, element_coords, length_coord_array, &                      ! Input variables
    dof_increment, dof_total, length_dof_array, &                                                ! Input variables
    n_state_variables, initial_state_variables, &                                                ! Input variables
    updated_state_variables,element_stiffness,element_residual, fail)      ! Output variables
...
subroutine user_element_fieldvariables(lmn, element_identifier, n_nodes, node_property_list, &           ! Input variables
    ...
    if ( element_identifier == 1001 ) then              ! Basic fully integrated 3D linear elastic element
    ...
    else if ( element_identifier == 1 ) then              ! Basic fully integrated 3D linear elastic element
    ...
    else if ( element_identifier == 10001 ) then              ! Basic fully integrated 3D linear elastic element
    ...
    else if ( element_identifier == 1002 ) then              ! Basic fully integrated 2D linear elastic element
    ...
    else if ( element_identifier == 3001 ) then              ! Basic fully integrated 2D linear elastic element
        ...
        call fieldvars_gurson_3dbasic(lmn, element_identifier, n_nodes, node_property_list, &         ! Input variables
            ...
            nodal_fieldvariables)      ! Output variables
        !write(*,*) 'printing'
!    else if ( element_identifier == 600 ) then              ! Basic fully integrated 2D linear elastic element
!
!        call fieldvars_CahnHilliard_2dbasic(lmn, element_identifier, n_nodes, node_property_list, &         ! Input variables
!            n_properties, element_properties,element_coords, length_coord_array,  &                     ! Input variables
!            dof_increment, dof_total, length_dof_array,  &                                              ! Input variables
!            n_state_variables, initial_state_variables,updated_state_variables, &                       ! Input variables
!            n_field_variables,field_variable_names, &                                                   ! Field variable definition
